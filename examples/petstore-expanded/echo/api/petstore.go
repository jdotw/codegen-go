...
//go:generate go run github.com/12kmps/codegen-go/cmd/oapi-codegen --config=types.cfg.yaml ../../petstore-expanded.yaml
//go:generate go run github.com/12kmps/codegen-go/cmd/oapi-codegen --config=server.cfg.yaml ../../petstore-expanded.yaml
